...
description: "Add/fix GitHub Actions auto-release + Pages deploy in HTML game repos; diagnose deploy-pages failures without log access. Manual-only; do not use for unrelated work."
version: 2
updated: "2026-08-17"
