...
created: "2026-07-05"
description: "Build the noconsole AutoTuner .exe / Linux binary and publish a self-updating GitHub Release. Manual-only: invoke only for an explicit matching task; do not use for routine edits or adjacent project work."
version: 21
updated: "2026-08-17"
