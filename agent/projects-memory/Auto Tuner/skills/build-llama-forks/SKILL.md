...
created: "2026-07-17"
description: "Build llama.cpp and local forks through the Auto Tuner *_llama_build.txt scripts, including server-capable OCR builds and Vulkan/VS 2026 failure recovery. Manual-only: invoke only for an explicit matching task; do not use for routine edits or adjacent project work."
version: 6
updated: "2026-08-17"
