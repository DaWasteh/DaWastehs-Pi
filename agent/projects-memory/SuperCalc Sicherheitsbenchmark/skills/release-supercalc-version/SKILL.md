...
created: "2026-07-06"
description: "Prepare and push a SuperCalc benchmark release with semver tag and archive data. Manual-only: invoke only for an explicit matching task; do not use for routine edits or adjacent project work."
version: 2
updated: "2026-08-17"
