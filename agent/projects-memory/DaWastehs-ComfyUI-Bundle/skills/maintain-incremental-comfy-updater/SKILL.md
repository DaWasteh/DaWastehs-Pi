...
created: "2026-08-11"
description: "Maintain and release the safe incremental Windows ComfyUI updater for this bundle. Manual-only: invoke only for an explicit matching task; do not use for routine edits or adjacent project work."
version: 2
updated: "2026-08-17"
...
5. L:/GitHub/DaWasteh ComfyUI Nodes is absent, and git status is clean after release.
