...
created: "2026-08-02"
description: "Build and validate a realistic local VRM from one image using Qwen, RMBG, native Hunyuan3D, Blender and the VRM addon. Manual-only: invoke only for an explicit matching task; do not use for routine edits or adjacent project work."
version: 3
updated: "2026-08-17"
