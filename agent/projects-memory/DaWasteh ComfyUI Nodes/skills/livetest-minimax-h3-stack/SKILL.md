...
created: "2026-08-08"
description: "Alle neun MiniMax-H3-Workflows inklusive Complete-Song, Identity-Lock, Originalaudio und Repo↔ComfyUI-Synchronität real validieren. Manual-only: invoke only for an explicit matching task; do not use for routine edits or adjacent project work."
version: 3
updated: "2026-08-17"
...
## Procedure
1. Vor Start Repo `L:/GitHub/DaWasteh ComfyUI Nodes` und Runtime `L:/ComfyUI/ComfyUI` vergleichen; betroffene H3-Workflows und DaWasteh-H3-Pakete gezielt synchronisieren und SHA-256 prüfen. Fremde ComfyUI-Core-Änderungen nicht berühren.
