...
created: "2026-07-26"
description: "Alle Workflows dieses Repos kollisionsfrei anordnen, nodespezifische Parameter-Notes erzeugen und Release-Invarianten prüfen. Manual-only: invoke only for an explicit matching task; do not use for routine edits or adjacent project work."
version: 2
updated: "2026-08-17"
