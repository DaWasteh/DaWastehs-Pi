...
created: "2026-08-01"
description: "Create realistic or stylized Workflow-06-compatible VRM0 texture variants locally from three references plus a prompt, with an optional strict Meshy cloud candidate path. Manual-only: invoke only for an explicit matching task; do not use for routine edits or adjacent project work."
version: 3
updated: "2026-08-17"
