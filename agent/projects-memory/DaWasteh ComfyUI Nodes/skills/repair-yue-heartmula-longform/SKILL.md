...
created: "2026-07-28"
description: "YuE-Langform und HeartMuLa-Decoder in diesem Repo auf Windows-ROCm zuverlässig reparieren und validieren. Manual-only: invoke only for an explicit matching task; do not use for routine edits or adjacent project work."
version: 5
updated: "2026-08-17"
