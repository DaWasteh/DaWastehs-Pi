...
created: "2026-08-01"
description: "Improve realistic adult Live Avatar references, VRM motion, timer-free workflows, persistent Spout, and recorded OBS acceptance in this repo. Manual-only: invoke only for an explicit matching task; do not use for routine edits or adjacent project work."
version: 5
updated: "2026-08-17"
