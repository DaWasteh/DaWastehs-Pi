...
created: "2026-07-27"
description: "MOSS-TTS Local v1.5 Workflows in diesem Repo bauen, dokumentieren und sicher validieren. Manual-only: invoke only for an explicit matching task; do not use for routine edits or adjacent project work."
version: 5
updated: "2026-08-17"
...
6. Install workflows byte-identically into user/default/workflows/DaWasteh - Neu/Voice Design, restart the R9700 server only with an empty queue, and confirm all five MossTTS node types in live object_info.
